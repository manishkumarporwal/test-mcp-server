...
@mcp.tool()
async def add_expense(date: str, amount: float, category: str, subcategory: str = "", note: str = "") -> dict:  # Changed: added async and type hints
...
@mcp.tool()
async def list_expenses(start_date: str, end_date: str) -> list[dict]:  # Changed: added async and type hints
...
@mcp.tool()
async def summarize(start_date: str, end_date: str, category: str | None = None) -> list[dict]:  # Changed: added async and type hints
